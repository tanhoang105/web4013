    ...
    <div class="login-box-body">
        <form action="{{ url('/login') }}" method="post">
            ...
            <div class="form-group has-feedback">
                <input style="padding-left: 10px;" value="{{old('email')}}" type="text" name="email" class="form-control" placeholder="Username or Email">
            ...
            <div class="form-group has-feedback">
                <input style="padding-left: 10px;" value="{{old('name')}}" type="text" name="name" class="form-control" placeholder="Username or name">
                <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
                @error('name')
                    <span style="color: red">{{$message}}</span>
                @endif
